...
STATUS_HK = { 0: "Aus", 1: "Heizbetrieb", 2: "Anschieben", 3: "Vorhaltezeit", 4: "Gesperrt", 5: "Inbetriebnahme", 6: "Frostschutz", 7: "Estrich", 8: "Kühlung/Überschuss", 9: "Manuell", 10: "Notbetrieb", 11: "Nicht installiert" }
STATUS_WW = { 0: "Kein Bedarf", 1: "Ladung läuft", 2: "Frostschutz", 3: "Warten", 4: "Nachlauf Ladepumpe", 5: "Puffer/Kessel zu warm", 13: "Sperre durch SmartHome" }
STATUS_POOL = { 0: "Keine Erweiterung", 1: "Aus", 2: "Gesperrt", 3: "Warm genug", 4: "Frostschutz", 5: "Aufheizen Normal", 6: "Aufheizen Komfort", 7: "Solarer Überschuss", 8: "Gesperrt (Puffer kalt)", 9: "Gesperrt (WW Vorrang)", 10: "Kühlen" }
STATUS_CIRC = { 0: "Nicht verwendet", 1: "Nachlauf", 2: "Gesperrt", 3: "Aus", 4: "Gesperrt (Fühler)", 5: "An", 6: "Frostschutz", 7: "Sperre SmartHome" }
STATUS_BOILER = { 0: "Aus", 1: "An", 2: "An für Heizkreis", 3: "Lädt Puffer", 4: "Gesperrt", 5: "Kühlung WP", 6: "WW Bereitung" }
STATUS_SOLAR = { 0: "Wartet", 1: "Frostschutz", 2: "Anschieben", 3: "Einschaltverzögerung", 4: "Ladung läuft", 5: "Speicher voll", 6: "Kollektor überhitzt", 7: "Manuell", 8: "Messung", 9: "Notbetrieb" }
...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    for s in SENSOR_DEFINITIONS:
        if s[6] and not entry.data.get(s[6]): continue
...
class ParadigmaSensor(CoordinatorEntity, SensorEntity):
    def __init__(self, coordinator, entry, definition):
        ...
        if self._dev_class == SensorDeviceClass.ENERGY: self._attr_state_class = SensorStateClass.TOTAL_INCREASING
        elif self._dev_class in [SensorDeviceClass.TEMPERATURE, SensorDeviceClass.POWER]: self._attr_state_class = SensorStateClass.MEASUREMENT
        else: self._attr_state_class = None
    ...
    def native_value(self):
        ...
        if self._unit == UnitOfTemperature.CELSIUS and raw > 32767: raw -= 65536
        return raw * self._factor

    @property
    def native_unit_of_measurement(self):
        if self._dev_class is None and self._unit is None: return None
        return self._unit
    
    @property
    def device_class(self): return self._dev_class